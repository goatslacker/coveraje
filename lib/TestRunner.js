        ...
        function runTest(code, runner) {
            ...
            event
                ...
                .onStart(function (key) {
                    ...
                    var context = instance.context = createContext();
                    try {
                        if (instance.nodejs === true) {
                          context.module = { exports: dune.string(code.codeToRun, instance.fileName, context) };
